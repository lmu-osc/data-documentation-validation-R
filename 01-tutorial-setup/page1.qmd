...
Throughout this tutorial, you'll run R code interactively. For now, you can type commands directly into the _Console_ tab. On the next page, you'll create an R script file to keep your code organized.
...
Before moving to the next section, verify your setup is working by typing this command into the _Console_:
