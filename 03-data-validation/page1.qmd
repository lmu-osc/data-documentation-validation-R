...
The messy Palmer Penguins dataset you downloaded contains 30 intentional errors. Let's find them:
...
In the next section, you'll learn systematic techniques for spotting these problems using summary statistics and visualization in R. You'll work with the messy penguins dataset to detect all 30 errors.