...
The `{datawizard}` package provides a simple, reliable way to create data dictionaries automatically. It generates structured tables that include:
...
You can add descriptive labels to make the codebook more informative:
